...
private:
    ...
    string findHelper(const string& x, AVLNode* curNode) const;

    //private helper method for numnode
    int numNodesHelper(AVLNode* node) const;

    //private helper method for pathTo
    string pathToHelper(const string& x, AVLNode* curNode) const;

    //private helper method for insert
    void insertHelper(AVLNode*& n, const string& x);
};
