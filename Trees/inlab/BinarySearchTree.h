...
private:
    ...
    void insertHelper(BinaryNode*& n, const string& x);

    //private helper method for find
    string findHelper(const string& x, BinaryNode* curNode) const;

    //private helper method for numNode
    int numNodesHelper(BinaryNode* node) const;

    //private helper method for pathTo
    string pathToHelper(const string& x, BinaryNode* curNode) const;
